    ...
    <div>
      ...
      <section style={{ padding: "60px 40px 120px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 80 }}>
          <div>
            <Placeholder label="founder portrait" aspect="3/4" />
          ...
          <div>
            ...
            <p style={{ fontFamily: "'Geist', sans-serif", fontSize: 17, lineHeight: 1.7, color: "var(--muted)", marginTop: 20, maxWidth: 640 }}>
              We started in 2024 in Tampa, working with two early clients in B2B SaaS and professional services. The model worked. Today we run outreach for clients across the country — but the principle hasn&apos;t changed: align the incentives, and the rest follows.
            </p>
          </div>
        </div>
      </section>
